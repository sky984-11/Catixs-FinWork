...
class User(BaseModel, TimestampMixin):
    ...
    feishu_open_id = fields.CharField(max_length=100, null=True, unique=True, description="飞书 open_id", index=True)
    feishu_union_id = fields.CharField(max_length=100, null=True, unique=True, description="飞书 union_id", index=True)
    feishu_user_id = fields.CharField(max_length=100, null=True, unique=True, description="飞书 user_id", index=True)
