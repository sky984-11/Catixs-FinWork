...
class CompanyCreate(BaseModel):
    role: Optional[int] = Field(0, description="角色: 0=内部, 1=客户, 2=供应商")
    name: str = Field(..., example="263", description="公司简称")
    legal_name: str = Field("", example="263 Global Communications Limited", description="公司全称")
    logo_url: str = Field("", example="/logos/catixs.svg", description="公司Logo")
    code: str = Field("", example="")
    country: str = Field("", example="中国")
    address: str = Field("", example="")
    noc_email: str = Field("", example="")
    noc_phone: str = Field("", example="")
    remark: str = Field("", example="")
    tax_no: str = Field("", example="")
    company_email: str = Field("", example="")
    bill_email: str = Field("", example="", description="财务邮箱")
    contact_person: str = Field("", example="", description="财务联系人")
...
class CompanyUpdate(BaseModel):
    ...
    legal_name: str = Field("", example="263 Global Communications Limited", description="公司全称")
    logo_url: str = Field("", example="/logos/catixs.svg", description="公司Logo")
    code: str = Field("", example="CP00001")
    country: str = Field("", example="中国")
    address: str = Field("", example="")
    noc_email: str = Field("", example="")
    noc_phone: str = Field("", example="")
