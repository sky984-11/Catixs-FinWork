...
class Settings(BaseSettings):
    ...
    IPXO_SCOPE: str = "billing nethub-data nethub-analytics"
    IPINFO_TOKEN: str = ""
    ZENLAYER_ACCESS_KEY_ID: str = ""
    ZENLAYER_ACCESS_KEY_PASSWORD: str = ""
    ZENLAYER_API_BASE: str = "https://console.zenlayer.com/api/v2"
    ZENLAYER_SDN_VERSION: str = "2026-04-01"
    ZENLAYER_ACCOUNT_EMAIL: str = ""
    EQUINIX_CLIENT_ID: str = ""
    EQUINIX_CLIENT_SECRET: str = ""
    EQUINIX_API_URL: str = "https://api.equinix.com"
    CLIENT_ID: str = ""
    CLIENT_SECRET: str = ""
    WEB_BASE_URL: str = ""
