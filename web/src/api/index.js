...
export default {
  ...
  virtualMachineApi: {
    ...
    dhcpPools: (params = {}) => request.get('/pve/dhcp-pools', { params }),
    dhcpPoolOptions: (params = {}) => request.get('/pve/dhcp-pools/options', { params }),
    createDhcpPool: (data = {}) => request.post('/pve/dhcp-pools', data),
    updateDhcpPool: (id, data = {}) => request.put(`/pve/dhcp-pools/${id}`, data),
    deleteDhcpPool: (id) => request.delete(`/pve/dhcp-pools/${id}`),
  ...
  productCenterApi: {
    options: () => request.get('/product-center/options'),
    listCategories: () => request.get('/product-center/categories'),
    createCategory: (data = {}) => request.post('/product-center/categories', data),
    updateCategory: (id, data = {}) => request.put(`/product-center/categories/${id}`, data),
    deleteCategory: (id) => request.delete(`/product-center/categories/${id}`),
    listProducts: (params = {}) => request.get('/product-center/products', { params }),
    createProduct: (data = {}) => request.post('/product-center/products', data),
    updateProduct: (id, data = {}) => request.put(`/product-center/products/${id}`, data),
    deleteProduct: (id) => request.delete(`/product-center/products/${id}`),
    listAttributes: (params = {}) => request.get('/product-center/attributes', { params }),
    createAttribute: (data = {}) => request.post('/product-center/attributes', data),
    updateAttribute: (id, data = {}) => request.put(`/product-center/attributes/${id}`, data),
    deleteAttribute: (id) => request.delete(`/product-center/attributes/${id}`),
    listSpecConfigs: (params = {}) => request.get('/product-center/spec-configs', { params }),
    ...
    deletePriceHistory: (id) => request.delete('/product-center/price-history/' + id),
    ...
    updateTemplate: (id, data = {}) => request.put(`/product-center/templates/${id}`, data),
    deleteTemplate: (id) => request.delete(`/product-center/templates/${id}`),
  },
