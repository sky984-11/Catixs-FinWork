...
const reminders = [
  { title: '项目临近提醒', desc: '规划中、进行中、验收中的项目距离 ETA 还有一天时，发送飞书提醒给项目负责人。' },
  { title: '项目到期提醒', desc: '规划中、进行中、验收中的项目到达 ETA 时，再发送一次提醒给项目负责人。' },
...
<template>
  <CommonPage show-footer title="项目看板文档">
    ...
    <section class="doc-section faq">
      ...
      <article>
        <strong>为什么项目或子任务没有提醒？</strong>
        <p>可能是项目已完成或归档、项目/子任务没有 ETA、子任务已完成、负责人没有维护手机号、手机号无法匹配飞书用户，或者该阶段提醒已经发送过。</p>
      </article>
      <article>
